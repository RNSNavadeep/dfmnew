...
import DesignerChat from './components/designerchat.jsx';
...
export default function Home() {
  ...
  const mainCategories = [
    ...
    },
    {
      id: 'women',
      label: 'Women',
      bgImage: 'https://cdn.pixabay.com/photo/2018/06/25/17/01/fashion-3497408_1280.jpg',
    },
    {
      id: 'kids',
      label: 'Kids',
      bgImage: 'https://images.pexels.com/photos/1620760/pexels-photo-1620760.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    },
    {
      id: 'combo',
      label: 'Combo',
      bgImage: 'https://images.pexels.com/photos/996329/pexels-photo-996329.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    },
  ];
  ...
  const newProducts = [
    { id: 1, name: 'Floral Kurti Set', price: '₹999', img: 'https://monamaar.com/cdn/shop/files/6GmJCEu9rYGlpSjcip_uyw8P1l-JSkJyGfKbhE4jUDc__plaintext_638218111696314915.jpg?v=1686220860' },
    { id: 2, name: 'Men Ethnic Kurta', price: '₹1299', img: 'https://assets.ajio.com/medias/sys_master/root/20241029/F6KF/6720e5dd260f9c41e8abe92d/-473Wx593H-700669982-grey-MODEL.jpg' },
    { id: 3, name: 'Kids Party Dress', price: '₹799', img: 'https://m.media-amazon.com/images/I/A106VvqFTwL._AC_UY1100_.jpg' },
    { id: 4, name: 'Combo Lounge Set', price: '₹1499', img: 'https://bandhanipalace.co.in/images/product/sub_images/2025/01/desire-vol-896-night-wear-couple-combo-set-4-2025-01-07_13_19_58.jpeg' },
  ];
    ...
    <div className="min-h-screen bg-[#F2E9E4] flex flex-col">
      ...
      <header className="bg-[#7B2CBF] text-white p-4 flex flex-col md:flex-row items-center justify-between shadow-lg">
        ...
        <div className="mb-3 md:mb-0">
          <img
            src="frontend/app/Gemini_Generated_Image_jdf35gjdf35gjdf3.png"
            alt="DressForMe Logo"
            className="h-12 md:h-14 object-contain"
          />
        </div>

        <div className="flex-1 max-w-2xl mx-auto mb-3 md:mb-0 flex items-center">
  ...
  className="ml-1 bg-[#FFD166] text-[#7B2CBF] p-3 rounded-full shadow-md hover:scale-110 transition flex-shrink-0"
>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {mainCategories.map((cat) => (
            <button
              ...
              className={`relative h-48 md:h-64 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-4 border-transparent group ${
        ...
        <section className="py-10 px-6 bg-gray-50">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-7xl mx-auto">
            {currentSubs.map((sub, i) => (
              ...
              >
                <img
                  src="https://www.fabhotels.com/blog/wp-content/uploads/2018/10/600x400-12.jpg"
                  alt={sub.label}
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8 text-center md:text-left text-sm">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              ...
              {/* Instagram */}
              <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-[#FFD166] transition" title="Instagram">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-[#FFD166] transition" title="Facebook">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-[#FFD166] transition" title="YouTube">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
